...
def game_hash 
          ...
          :players => [
                   {:player_name =>  "Alan Anderson",
                    ...
                    {:player_name => "Jason Terry",
				            ...
				            ]}, #end of players array & home team hash 
  :away => {:team_name => "Charlotte Hornets",
          ...
          :players => [{:player_name => "Jeff Adrien", 
                    ...
                    ]}} #end of players array, home team hash & game hash 
end 
...
def long_name_steals_a_ton?
   ...
   best_player = "nobody"
    ...
    if best_player == player_with_longest_name
      return true 
    end 
  end 
end 
